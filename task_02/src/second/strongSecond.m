% Режим сильного торможения для второго типа ограничений на управление
function [is, uMat, xMat, timeVec, value] = strongSecond(T, L, S, eps, alpha, k1, k2, N, modeStr)
